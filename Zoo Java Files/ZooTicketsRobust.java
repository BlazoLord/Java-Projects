...
public class ZooTicketsRobust
{
   ...
   public static void serveTicketsForOneGroup() throws Exception {
        try {
            ...
            if (numberAdults < 0) {
                System.out.println("ERROR: Invalid number of adults!");
                return;
            }
            if (numberChildren < 0) {
                System.out.println("ERROR: Invalid number of children!");
                return;
            } else if (numberAdults == 0 && numberChildren == 0) {
            ...
            System.out.println("Incorrect data format for integers!");
